...
import es.cesguiro.movies.controller.response.CharacterMovieResponse;
import es.cesguiro.movies.domain.entity.Actor;
import es.cesguiro.movies.domain.entity.CharacterMovie;
import es.cesguiro.movies.dto.CharacterMovieDTO;
...
public interface CharacterMovieMapper {
    ...
    @Mapping(target = "actorDTO", expression = "java(ActorMapper.mapper.toActorDTO(characterMovieEntity.getActorEntity()))")
    CharacterMovieDTO toCharacterMovieDTO(CharacterMovieEntity characterMovieEntity);

    List<CharacterMovieDTO> toCharacterMovieDTOList(List<CharacterMovieEntity> characterMovieEntityList);

    @Mapping(target = "actorResponse", expression = "java(ActorMapper.mapper.toActorResponse(characterMovieDTO.getActorDTO()))")
